...
const RUST_TEMPLATE: &str = include_str!("templates/rust_standalone.nix");
const PYTHON_TEMPLATE: &str = include_str!("templates/python_standalone.nix");
const MULTI_TEMPLATE: &str = include_str!("templates/multi_standalone.nix");

pub fn generate_standalone(info: &ProjectInfo, config: &FlakeConfig) -> Result<GeneratedFlake> {
